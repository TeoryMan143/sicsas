...
function SideNav() {
  ...
  return (
    <>
      <div
        className={cn('absolute h-dvh w-dvw bg-slate-600/50 z-20 hidden', {
          block: open,
        })}
      ...
      <nav
        className={cn(
          'absolute rounded-xl py-10 pl-7 pr-12 bg-white shadow-lg top-3 z-30 left-0 -translate-x-full transition-transform',
          {
            'translate-x-0': open,
          },
        )}
